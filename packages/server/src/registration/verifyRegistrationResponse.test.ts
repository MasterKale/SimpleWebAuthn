...
Deno.test('should enforce CTS check by default', async () => {
  ...
  await assertRejects(async () => {
    await verifyRegistrationResponse({
      response: {
        id:
          'AS_TChPtwkqgPwDxkkF39yjfaPJtKiwMGIY69EV7udG2xaP8hYnjJsPS7VPnUA2xaUZc7dHot5WwYRRoavu7Ais',
        rawId:
          'AS_TChPtwkqgPwDxkkF39yjfaPJtKiwMGIY69EV7udG2xaP8hYnjJsPS7VPnUA2xaUZc7dHot5WwYRRoavu7Ais',
        response: {
          clientDataJSON:
            'eyJ0eXBlIjoid2ViYXV0aG4uY3JlYXRlIiwiY2hhbGxlbmdlIjoiWjI5dloyeGxMVzloZFhSb01ud3hNREUyTVRFME1EUTVOREk1T0RRek56YzROak0iLCJvcmlnaW4iOiJodHRwczpcL1wvbG9naW4uYXV0aHJlc3MuaW8iLCJhbmRyb2lkUGFja2FnZU5hbWUiOiJjb20uYW5kcm9pZC5jaHJvbWUifQ',
          attestationObject:
      ...
      requireUserVerification: false,
      requireUserPresence: false,
      attestationSafetyNetEnforceCTSCheck: undefined, // <---- Intentionally undefined
    });
  }, 'should reject on bad ctsProfileMatch');
...
Deno.test('should skip CTS check when enforcement option is false', async () => {
  ...
  const verification = await verifyRegistrationResponse({
    ...
    requireUserVerification: false,
    requireUserPresence: false,
    attestationSafetyNetEnforceCTSCheck: false, // <---- Skipping enforcement here
  });
