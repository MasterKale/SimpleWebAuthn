...
test('should parse attestation data', () => {
  ...
  expect(base64url.fromBuffer(credentialID!)).toEqual('drsqybluveECHdSPE_37iuq7wESwP7tJnbFZ7X_Ie_o');
  expect(base64url.fromBuffer(credentialPublicKey!, 'base64')).toEqual(
  ...
  expect(base64url.fromBuffer(aaguid!, 'base64')).toEqual('yHzdl1bBSbieJMs2NlTzUA==');
